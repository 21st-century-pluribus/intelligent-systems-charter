...
| [essays/](essays/) | Essays on why the charter exists. Start with [00: A Promise Is Not Enough](essays/00_a-promise-is-not-enough.md), then [01: The Law Must Arrive First](essays/01_the-law-must-arrive-first.md), [02: A Brain Is Not a Body](essays/02_a-brain-is-not-a-body.md), [03: A Treaty Before the Race](essays/03_a-treaty-before-the-race.md), [04: A License Plate for Every Agent](essays/04_a-license-plate-for-every-agent.md) and [05: What We Stand to Lose](essays/05_what-we-stand-to-lose.md). |
